...
def main():
	...
	argparser.add_argument("-a", "--ipaddr", help="ip address", default="http://localhost:8035")
	...
	print("Server ip addr ", args.ipaddr)

	userid = args.id
	if args.subscribe:
		subscribe(args.ipaddr, userid, args.subscribe)
	elif args.unsubscribe:
		unsubscribe(args.ipaddr, userid, args.unsubscribe)
	elif args.printfeeds:
		print_supported_feeds(args.ipaddr)
	else:
		pollfeeds(args.ipaddr, userid)
	return 0
